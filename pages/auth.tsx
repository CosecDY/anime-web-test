        ...
        <div className="relative h-full w-full bg-[url('/images/background.jpg')] bg-no-repeat bg-center bg-fixed bg-cover" >
            <div className="bg-black w-full h-full lg:bg-opacity-20">
                ...
                <div className="flex justify-center">
                    <div className="bg-black bg-opacity-70 px-16 py-16 self-center mt-2 lg:w-2/5 lg:max-w-mb rounded-md w-full">
                        ...
                        <p className="text-neutral-500 mt-12">
                            {variant == 'login' ? 'First time using anime-wep?' : 'Already have an account?'}
